...
status_code=$(curl -sSk -H "Authorization: Bearer $KUBE_TOKEN" \
    "https://c5.che01.containers.cloud.ibm.com:21426/api/v1/namespaces/$NAMESPACE/services/bulletin-board-service" \
    -X GET -o /dev/null -w "%{http_code}")
...
if [ $status_code == 404 ]; then
 ...
 curl --fail -H 'Content-Type: application/json' -sSk -H "Authorization: Bearer $KUBE_TOKEN" \
    "https://c5.che01.containers.cloud.ibm.com:21426/api/v1/namespaces/$NAMESPACE/services" \
